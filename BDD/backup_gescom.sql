...
CREATE TABLE `orders` (
  ...
  `ord_order_date` date NOT NULL DEFAULT curtime(),
...
CREATE TABLE `products` (
  ...
  `pro_add_date` date NOT NULL DEFAULT curtime(),
  `pro_update_date` datetime NOT NULL DEFAULT curtime(),
  `pro_publish` tinyint(1) NOT NULL,
  `cat_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`pro_id`),
  KEY `cat_id` (`cat_id`),
  KEY `products_index` (`pro_ref`),
...
-- Dump completed on 2023-02-28 14:21:39
